...
extern const int16_t _wk_constants[] PROGMEM = {
#if (FFT_N ==  256)
  #include <ArduinoFFT2/FFT/wklookup_256.inc>
#elif (FFT_N ==  128)
  ...
  #if (FFT_N == 256)
    #include <ArduinoFFT2/FFT/256_reorder.inc>
  #elif (FFT_N == 128)
  ...
  extern const uint8_t _log_table[] PROGMEM = {
    #include <ArduinoFFT2/FFT/decibel.inc>
  };
#endif
  ...
  #if (FFT_N ==  256)
    #include <ArduinoFFT2/FFT/hann_256.inc>
  #elif (FFT_N ==  128)
